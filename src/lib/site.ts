  ...
  suppliers: [
    {
      slug: "filiperson",
      name: "Filiperson",
      vertical: "Papelaria & Escritório",
      descriptor: "Papéis especiais e cadernetas Filibook Note. Indústria RJ desde 1983.",
    },
    {
      slug: "ccm",
      name: "CCM Indústria",
      vertical: "Higiene Pessoal",
      descriptor: "Fraldas infantis Hipopó, Estrelinha e Pequerrucho; absorventes Wellness incontinência adulta. Uberaba/MG.",
    },
    {
      slug: "yins",
      name: "Yin’s Brasil",
      vertical: "Eletroportáteis & Viagem",
      descriptor: "Eletroportáteis linha marrom (liquidificador, cafeteira, sanduicheira) e linha de viagem (malas ABS). Importadora.",
    },
    {
      slug: "tt-master",
      name: "TT Master",
      vertical: "Acessórios eletrônicos",
      descriptor: "Periféricos e acessórios eletrônicos de proteção.",
    },
  ],
