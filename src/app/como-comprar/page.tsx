...
export const metadata: Metadata = {
  title: "Como comprar",
  description:
    "Como comprar pela Repon: cadastro PJ pelo WhatsApp, validação em 24h, despacho em 48h. Mínimo R$ 800. Frete subsidiado acima de R$ 1.500. Para revendedores no Sudeste e Sul.",
