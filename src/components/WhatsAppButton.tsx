...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      <div className="w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg shadow-black/15 hover:scale-105 active:scale-95 transition-transform duration-200">
        <svg
          viewBox="0 0 32 32"
          fill="white"
